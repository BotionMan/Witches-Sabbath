...
public class RowanTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {
	   ...
	   public RowanTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1, int int_1, BlockState blockState_1, BlockState blockState_2, boolean boolean_2) {
	   ...
	   public boolean generate(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, Random random_1, BlockPos blockPos_1, MutableIntBoundingBox mutableIntBoundingBox_1) {
	      ...
	      if (blockPos_1.getY() >= 1 && blockPos_1.getY() + int_1 + 1 <= 256) {
	         ...
	         for(int int_2 = blockPos_1.getY(); int_2 <= blockPos_1.getY() + 1 + int_1; ++int_2) {
	            ...
	            for(int_9 = blockPos_1.getX() - int_3; int_9 <= blockPos_1.getX() + int_3 && generates; ++int_9) {
	               for(int_18 = blockPos_1.getZ() - int_3; int_18 <= blockPos_1.getZ() + int_3 && generates; ++int_18) {
